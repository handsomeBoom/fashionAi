...
def test_dataset():
    ...
    filename_queue = tf.train.string_input_producer(['../Datasets/tfrecords/blouse_0000.tfrecord'], num_epochs=None)
    reader = tf.TFRecordReader()
    _, serialized_example = reader.read(filename_queue)
    
    # paesing for record file
...
if __name__ == '__main__':
    ...
    # FIXME: can not find tfrecord file
    ...
    if not os.path.exists(config.RECORDS_DATA_DIR):
